...
import com.uce.microserviceupdatecategory.repository.microserviceupdatecategoryRepository;
...
public class microserviceupdateController {
    ...
    @Autowired
    private microserviceupdatecategoryRepository microserviceupdatecategoryRepository;
    ...
    public ResponseEntity<Category> updateCategory(@PathVariable UUID id, @RequestBody Category categoryDetails) {
        Optional<Category> existingCategory = microserviceupdatecategoryRepository.findById(id);
        if (existingCategory.isPresent()) {
            ...
            Category updatedCategory = microserviceupdatecategoryRepository.save(category);
